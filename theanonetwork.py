"""
This is a neural network designed to run on the MNIST dataset based on the code from the MLP Tutorial on Theano
Designed by Jack Gartland George Wildridge.
"""
...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        if os.path.isfile("MLP_Classifier.save"):
            f = file("MLP_Classifier.save", "rb")
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=50,
   ...
   """
    ...
    #test_set_x = image_array
    #test_set_x = theano.tensor.as_tensor_variable(test_set_x)
    #test_set_y = [8]
